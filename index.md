...
<section class="resume-section" id="about">
  <div class="resume-section-content">
    ...
    <p class="lead mb-5">A fresh cek gantigraduate dedicated to leveraging data analytics and programming skills to drive innovative solutions, particularly in the bioinformatics field. Experienced in various bioinformatics tools, data analytics, and web programming, with a strong ability to lead and generate new ideas.</p>
