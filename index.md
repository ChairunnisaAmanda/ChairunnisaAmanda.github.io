...
<section class="resume-section" id="about">
  <div class="resume-section-content">
    ...
    <p class="lead mb-5">A bioinformatics master student dedicated to leveraging data analytics and programming skills to drive innovative solutions, particularly in the bioinformatics field. Experienced in various bioinformatics tools, data analytics, and web programming, with a strong ability to lead and generate new ideas.</p>
    <div class="social-icons">
      ...
      <h3>Check out my <a href="{{ '/blog' | relative_url }}">BLOG</a></h3>
    </div>
  </div>
</section>
  ...
  <div class="resume-section-content">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between">
        <div class="flex-grow-1">
            <h3 class="mb-0">Co-Founder and Curriculum Lead</h3>
              <div class="subheading mb-3">Omics Lite</div>
                  <p>I have worked on developing foundational bioinformatics learning materials, covering basic concepts, workflows, and commonly used tools to help beginners get started. I also designed a project-based learning (PBL) curriculum and facilitated online sessions and introductory workshops, aiming to make the learning experience more hands-on and engaging. Along the way, I built connections with labs, lecturers, and student organizations, while making sure all the content stays accurate, relevant, and supported by well-curated learning resources.

</p>
              </div>
              <div class="flex-shrink-0"><span class="text-primary">October 2025 - Current</span></div>
              </div>
    <div class="d-flex flex-column flex-md-row justify-content-between">
        <div class="flex-grow-1">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between">
        <div class="flex-grow-1">
            <h3 class="mb-0">Internship: Next Generation Sequencing</h3>
              <div class="subheading mb-3">Hackbio</div>
                  <p>Learn how to do analysis on genomics and transcriptomics data.</p>
              </div>
              <div class="flex-shrink-0"><span class="text-primary">August-September 2025</span></div>
              </div>
    <div class="d-flex flex-column flex-md-row justify-content-between">
        <div class="flex-grow-1">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
        <div class="flex-grow-1">
            <h3 class="mb-0">Web Developer (Executive Committee)</h3>
              ...
              <div class="flex-shrink-0"><span class="text-primary">2023, 2025</span></div>
              </div>
    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
        <div class="flex-grow-1">
...
<section class="resume-section" id="education">
  <div class="resume-section-content">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
        <div class="flex-grow-1">
         <h3 class="mb-0">The University of Western Australia</h3>
         <div class="subheading mb-3">Master of Bioinformatics</div>
            <div>Funded by LPDP Scholarship</div>
            <p>GPA: 3.90</p>
            </div>
